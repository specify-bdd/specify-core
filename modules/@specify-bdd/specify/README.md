...
3. [Configuration](#configuration)
    * [Cucumber](#configuration-cucumber)
    * [Plugins](#configuration-plugins)
4. [Defining Behavior](#defining-behavior)
5. [Running Tests](#running-tests)
    * [Runtime Options](#running-tests-runtime-options)
6. [Extending Specify](#extending-specify)
    * [Cucumber Support Code](#extending-specify-support-code)
        * [Step Definitions](#extending-specify-support-code-step-definitions)
        * [Hooks](#extending-specify-support-code-hooks)
    * [Custom Plugins](#extending-specify-custom-plugins)
7. [Get Help](#get-help)
...
[Configuring Plugins](#configuration-plugins) for more info.
...
[Step Definitions](#extending-specify-support-code-step-definitions) for more.
...
| -p, --parallel <number_of_workers> | Run in parallel with the given number of workers.                               |
| --rerun                            | Rerun the failed tests from the last test run.                                  |
| --rerun-file <path>                | The location of the rerun log file.                                             |
| -r, --retry <number_of_retries>    | Retry failed tests up to the given number of times before counting them as
                                       failed.                                                                         |
...
## Extending Specify {#extending-specify}
...
config setting.  See [Cucumber configuration](#configuration-cucumber) for more details.
...
the callback function.  Specify's plugins (see [Installing Plugins](#installation-plugins)) provide 
prebuilt step definitions to help accelerate test automation, but you can also write your own step definitions to cover
behaviors unique to your use cases or combine multiple basic actions into one step.
...
support files in its `import` sub-property as shown in the [Cucumber configuration](#configuration-cucumber) section.
